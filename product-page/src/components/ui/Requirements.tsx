  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
      <div className="p-4 border-b border-gray-100 bg-gradient-to-r from-[#EB1F26]/10 to-[#f04e53]/10">
        <h2 className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#EB1F26] to-[#f04e53] flex items-center">
          ...
          {requirements.map((requirement) => (
            ...
            >
              {requirement.icon ? (
                ...
                <div className="w-8 h-8 rounded-full bg-gradient-to-r from-[#EB1F26]/10 to-[#f04e53]/10 flex-shrink-0 mr-3 flex items-center justify-center">
